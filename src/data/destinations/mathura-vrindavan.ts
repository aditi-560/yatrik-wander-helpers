...
export const mathuraVrindavanData: DestinationDetails = {
  ...
  festivals: [
    ...
    },
    {
      ...
      description: "Commemorating Lord Krishna's lifting of Govardhan Hill to protect the villagers from the wrath of Lord Indra. Devotees create small replicas of the hill using cow dung and worship them.",
    },
    {
      name: "Braj Mahotsav",
      month: "February-March",
      description: "A five-day cultural festival showcasing the rich heritage of the Braj region with music, dance, and art exhibitions celebrating Krishna's legacy.",
    },
  ],
  tips: [
    ...
    "Witness the evening Yamuna Aarti at Vishram Ghat for a spiritual experience.",
    "Photography is restricted in many temple sanctums, always ask for permission.",
    "Carry a water bottle and wear comfortable footwear as you'll be walking a lot.",
    "Start your temple visits early in the morning to avoid crowds and heat.",
    "Set aside at least 3-4 days to properly explore both Mathura and Vrindavan."
  ],
};
