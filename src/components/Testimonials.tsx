      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block bg-yatrik-tertiary/30 px-4 py-1.5 rounded-full mb-4">
            <p className="text-sm font-medium text-yatrik-primary">Traveler stories</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-yatrik-light border border-slate-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow"
            >
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-yatrik-dark">{testimonial.name}</h3>
