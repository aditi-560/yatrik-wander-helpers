...
const Hero = () => {
  ...
  return (
    <section className="pt-20 pb-16 md:pt-28 md:pb-24 bg-gradient-to-r from-yatrik-yellow/50 via-yatrik-primary/30 to-yatrik-blue/20 dark:from-yatrik-purple/30 dark:via-yatrik-darkBg dark:to-yatrik-darkBg/90 theme-transition">
