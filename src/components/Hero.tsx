...
const Hero = () => {
  return (
    <section className="pt-20 pb-16 md:pt-28 md:pb-24 bg-gradient-to-r from-yatrik-blue/10 via-yatrik-purple/10 to-yatrik-pink/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center gap-12">
          {/* Text content */}
          <div className="flex-1 space-y-6 text-center md:text-left">
            <div className="inline-block bg-yatrik-purple/20 px-4 py-1.5 rounded-full">
              <p className="text-sm font-medium text-yatrik-purple">Travel without limits</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-2">
              <Button className="bg-yatrik-primary hover:bg-yatrik-primary/90 text-white px-8 py-6 text-lg">
                Download Now
              </Button>
              <Button variant="outline" className="border-yatrik-secondary text-yatrik-secondary hover:bg-yatrik-secondary/10 px-8 py-6 text-lg">
                Learn More
              </Button>
            </div>
          ...
          <div className="flex-1 relative">
            ...
            {/* Floating features */}
            <div className="absolute top-20 -left-8 bg-yatrik-blue text-white p-3 rounded-xl shadow-lg hidden md:flex items-center space-x-2 animate-float" style={{ animationDelay: '0.5s' }}>
              <MapPin className="h-5 w-5 text-white" />
              <span className="text-sm font-medium">Real-time location</span>
            </div>
            <div className="absolute bottom-24 -right-8 bg-yatrik-green text-white p-3 rounded-xl shadow-lg hidden md:flex items-center space-x-2 animate-float" style={{ animationDelay: '1s' }}>
            ...
            <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-yatrik-primary/30 via-yatrik-purple/30 to-yatrik-blue/30 rounded-full blur-3xl"></div>
          </div>
        </div>
      </div>
    </section>
