      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm mb-4">
            ...
            <span className="text-sm font-medium text-yatrik-dark dark:text-white theme-transition">Sacred Celebrations</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {festivals.map((festival, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-yatrik-yellow/20 dark:bg-yatrik-yellow/10 text-yatrik-dark dark:text-yatrik-yellow mb-3 theme-transition">
                <Clock className="h-4 w-4 mr-1" />
                <span className="text-sm font-medium">{festival.month}</span>
              </div>
              <h3 className="text-xl font-bold mb-2 text-yatrik-dark dark:text-white theme-transition">{festival.name}</h3>
              <p className="text-slate-700 dark:text-gray-300 text-sm theme-transition">{festival.description}</p>
            </div>
          ))}
        </div>
      </div>
